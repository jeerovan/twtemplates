  ...
  <div class="flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    >
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="/" on:click={closeMenu} class="block py-2 px-3 text-primary-700 hover:text-primary-500 dark:text-primary-500 dark:hover:text-primary-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">Home</a>
        </li>
        <li>
          <a href="/" on:click={closeMenu} class="block py-2 px-3 text-primary-700 hover:text-primary-500 dark:text-primary-500 dark:hover:text-primary-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">About</a>
        </li>
        <li>
          <a href="/" on:click={closeMenu} class="block py-2 px-3 text-primary-700 hover:text-primary-500 dark:text-primary-500 dark:hover:text-primary-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">Services</a>
        </li>
        <li>
          <a href="/" on:click={closeMenu} class="block py-2 px-3 text-primary-700 hover:text-primary-500 dark:text-primary-500 dark:hover:text-primary-400 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
        </li>
      </ul>
    </div>
  </div>
