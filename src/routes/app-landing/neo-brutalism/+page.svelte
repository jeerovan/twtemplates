...
<svelte:head>
  ...
  <style lang="postcss">
    .neo-shadow {
      box-shadow: 6px 6px 0px 1px rgb(0 0 0);
    }
    .neo-shadow-sm {
...
<nav class="bg-white  fixed w-full z-20 top-0 start-0">
  <div class="flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <!-- Menu items -->
    <div 
      class="items-center justify-between w-full md:flex md:w-auto md:order-1 { isMenuOpen ? 'block' : 'hidden' }"
      id="navbar-sticky"
    >
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="/" on:click={closeMenu} class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">Home</a>
        </li>
        <li>
          <a href="/" on:click={closeMenu} class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">About</a>
        </li>
        <li>
          <a href="/" on:click={closeMenu} class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">Services</a>
        </li>
        <li>
          <a href="/" on:click={closeMenu} class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="container mx-auto px-5 md:pt-10 bg-transparent">
  ...
  <div class="mb-32 md:mb-10 flex flex-col-reverse lg:flex-row items-center space-y-4 md:space-y-0 md:space-x-8 p-4 lg:h-screen mt-14 lg:mt-0">
    <div class="w-full lg:w-1/2 justify-center items-center md:text-left">
      <h1 class="text-5xl xl:text-6xl font-bold my-6 text-center lg:text-start dark:text-white">App Title</h1>
      <p class="text-xl xl:text-2xl text-gray-600 text-center lg:text-start dark:text-slate-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
      <div class="flex flex-col lg:flex-row justify-between space-y-8 lg:space-y-0 my-8 lg:space-x-4">
        <a href="/" class="">
          <img width="270"  height="71" class="rounded-lg ring-5 mx-auto lg:mx-0" src="/google_store.webp" alt="Google Play Store Button" />
        </a>
        <a href="/" class="">
          <img width="270"  height="71" class="rounded-lg ring-5 mx-auto lg:mx-0" src="/apple_store.webp" alt="Google Play Store Button" />
        </a>
      </div>
    </div>
    <div class="w-full lg:w-1/2">
      <!-- Image -->
      <img width="340" height="519" class="rounded-lg mx-auto neo-shadow" src="/mobile/app.webp" alt="mobile app" />
      <!-- Video 
  ...
  <div class="mb-32">
    ...
    <p class="mx-auto text-xl max-w-screen-lg text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
    <div class="py-10"></div>
    <div class="grid grid-cols-1 md:grid-cols-2 justify-items-center max-w-screen-xl mx-auto bg-yellow-300 rounded-xl">
      <div class="px-6 py-8">
        <div>
          <span class="inline-flex items-center justify-center p-2 bg-primary-500 rounded-md neo-shadow-sm">
  ...
  <!-- Testimonials -->
  <div class="mb-64">
    <h2 class="text-center text-3xl lg:text-4xl py-5 font-bold">What our users say</h2>
    <div class="max-w-screen-md mx-auto relative p-6 h-64">
      <div class="absolute transition-transform duration-500 ease-in-out transform {swipeEffectClass} bg-blue-300 dark:bg-slate-900 p-10 rounded-xl border-2 border-black neo-shadow-sm">
        ...
        <div class="flex flex-row space-x-6">
          <img class="rounded-full w-16 h16 border-2 border-black neo-shadow-sm" src="{testimonials[currentIndex].face}" alt="person face" />
          <div class="">
  ...
  <div class="mb-20">
    ...
    <div class="py-8"></div>
    <div id="pricing" class="p-10 max-w-screen-xl mx-auto bg-green-300 rounded-lg">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-between">
        <div class="rounded-2xl p-10 neo-shadow bg-white">
          ...
          <div class="flex justify-center items-center md:justify-center space-x-4 py-8">
            <a href="/" class="w-full text-center px-4 py-2 rounded border-2 border-black neo-shadow-sm bg-red-300">Buy Plan</a>
          </div>
          <ul>
            <li class="mb-5">
              <p class="flex items-center gap-4 text-sm dark:text-slate-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="w-5"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd"></path></svg> 5 Users
              </p>
            </li>
            <li class="mb-5">
              <p class="flex items-center gap-4 text-sm dark:text-slate-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="w-5"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd"></path></svg> Up to 1,000 subscribers
              </p>
            </li>
            <li class="mb-5">
              <p class="flex items-center gap-4 text-sm dark:text-slate-400">
        ...
        <div class="border rounded-2xl p-10 neo-shadow bg-white">
          ...
          <ul>
            <li class="mb-5">
              <p class="flex items-center gap-4 text-sm dark:text-slate-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="w-5"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd"></path></svg>50 Users
              </p>
            </li>
            <li class="mb-5">
              <p class="flex items-center gap-4 text-sm dark:text-slate-400">
  ...
  <div class="mb-32">
    ...
    <div class="py-8"></div>
    <div class="max-w-screen-xl mx-auto rounded-lg border-2 border-black neo-shadow" role="tablist">
      <button type="button" class="w-full text-start" on:click={() => toggleFaq(1)} role="tab" tabindex="0" aria-expanded={openIndex === 1}
        ...
        <div class="flex items-center justify-between w-full p-5 font-medium {openIndex == 1 ? 'text-gray-900 text-xl bg-gray-100' : 'text-gray-500 text-base'} rounded-lg hover:bg-gray-100 gap-3">
        ...
        <div class="{`${openIndex === 1 ? '' : 'hidden'}`}">
          <div class="p-5 border border-b-0 border-gray-200 bg-slate-50 font-medium">
            <p class="mb-2">Your app is awesome.</p>
            <p class="">Check out this guide to <a href="/" class="text-blue-600 dark:text-blue-500 hover:underline">get started</a> and start using it.</p>
          </div>
        </div>
      </button>
      <button type="button" class="w-full text-start" on:click={() => toggleFaq(2)} role="tab" tabindex="0" aria-expanded={openIndex === 2}
        ...
        <div class="flex items-center justify-between w-full p-5 font-medium {openIndex == 2 ? 'text-gray-900 text-xl bg-gray-100' : 'text-gray-500 text-base'} hover:bg-gray-100 gap-3">
        ...
        <div class={`${openIndex === 2 ? '' : 'hidden'}`}>
          <div class="p-5 border border-b-0 border-gray-200 bg-slate-50 font-medium">
            ...
            <p class="mb-2">Check out the <a href="/" class="text-blue-600 dark:text-blue-500 hover:underline">Figma design system</a> based on lorem ipsum guide.</p>
          </div>
        </div>
      </button>
      <button type="button" class="w-full text-start" on:click={() => toggleFaq(3)} role="tab" tabindex="0" aria-expanded={openIndex === 3}
        ...
        <div class="flex items-center justify-between w-full p-5 font-medium {openIndex == 3 ? 'text-gray-900 text-xl bg-gray-100' : 'text-gray-500 text-base'} hover:bg-gray-100 gap-3">
        ...
        <div class={`${openIndex === 3 ? '' : 'hidden'}`}>
          <div class="p-5 border border-b-0 border-gray-200 bg-slate-50 font-medium">
            <p class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <p class="mb-2">Learn more about these features:</p>
            <ul class="ps-5list-disc">
      ...
      <button type="button" class="w-full text-start" on:click={() => toggleFaq(4)} role="tab" tabindex="0" aria-expanded={openIndex === 4}
        ...
        <div class="flex items-center justify-between w-full p-5 font-medium {openIndex == 4 ? 'text-gray-900 text-xl bg-gray-100' : 'text-gray-500 text-base'} rounded-lg hover:bg-gray-100 gap-3">
        ...
        <div class={`${openIndex === 4 ? '' : 'hidden'}`}>
          <div class="p-5 border border-t-0 border-gray-200 bg-slate-50 font-medium rounded-lg">
            <p class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <p class="mb-2">check out the plans in pricing section.</p>
          </div>
        </div>
      </button>
    </div>
  ...
  <div class="mb-32">
    ...
    <div class="max-w-screen-xl mx-auto px-5">
      <div class="mx-auto w-full lg:w-1/2 py-10 px-5">
        <form method="post" on:submit|preventDefault={submitForm}>
          <div class="mb-6">
            ...
            <input id="name" placeholder="Name" bind:value={formData.name} class="bg-gray-50 border border-black text-gray-900 text-sm rounded-lg block w-full p-2.5 neo-shadow-sm"/>
          </div>
          <div class="mb-6">
            <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
            <input id="email" placeholder="Email" bind:value={formData.email} required class="bg-gray-50 border border-black text-gray-900 text-sm rounded-lg block w-full p-2.5 neo-shadow-sm"/>
          </div>
          <div class="grid grid-cols-1 md:grid-cols-2 md:gap-5">
            <div class="mb-6">
              <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">City</label>
              <input id="city" placeholder="City" bind:value={formData.city} class="bg-gray-50 border border-black text-gray-900 text-sm rounded-lg block w-full p-2.5 neo-shadow-sm"/>
            </div>
            <div class="mb-">
              <label for="default-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">State</label>
              <input id="state" placeholder="State" bind:value={formData.state} class="bg-gray-50 border border-black text-gray-900 text-sm rounded-lg block w-full p-2.5 neo-shadow-sm"/>
            </div>
          </div>
          ...
          <div class="py-6"></div>
          <button type="submit" class="w-full text-center px-4 py-2 rounded border-2 border-black neo-shadow-sm bg-red-300">Submit</button>
        </form>
      </div>
    </div>
  </div>
  ...
  <div class="mx-auto w-full p-6 py-6 lg:py-8">
      <div class="md:flex md:justify-between">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 class="mb-6 text-md font-semibold text-gray-900 uppercase dark:text-white">Resources</h2>
            ...
            <div>
                <h2 class="mb-6 text-md font-semibold text-gray-900 uppercase dark:text-white">Follow us</h2>
                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                    <li class="mb-4">
            ...
            <div>
                <h2 class="mb-6 text-md font-semibold text-gray-900 uppercase dark:text-white">Legal</h2>
                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                    <li class="mb-4">
